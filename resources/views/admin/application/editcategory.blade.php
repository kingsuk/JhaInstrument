        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Edit Application</h2>
            </div>
          </header>
          ...
          <section class="dashboard-counts no-padding-bottom">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="card-close">
                        ...
                        <form class="form-horizontal" method="POST" action="{{route('admin-edit-application-post')}}" enctype="multipart/form-data">
                        {{csrf_field()}}

        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">All Categoties</h2>
            </div>
          </header>
                  ...
                  <div class="card">
                    <div class="card-close">
                      <div class="dropdown show">
                        ...
                        <a href="{{route('admin-edit-categories',$data[$i]->id)}}" class="dropdown-item edit"> <i class="fa fa-gear"></i>Edit</a>
                        <a href="{{route('admin-delete-categories',$data[$i]->id)}}" onclick="return confirm('Are you sure?')" class="dropdown-item edit"> <i class="fa fa-gear"></i>Delete</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-close">
                      <div class="dropdown show">
                        <button type="button" id="closeCard" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" class="dropdown-toggle"><i class="fa fa-ellipsis-v"></i></button>
                        <div aria-labelledby="closeCard" class="dropdown-menu has-shadow" style="display: block;"><a href="#" class="dropdown-item remove"> <i class="fa fa-times"></i>Close</a>
                        <a href="{{route('admin-edit-categories',$data[$i+1]->id)}}" class="dropdown-item edit"> <i class="fa fa-gear"></i>Edit</a>
                        <a href="{{route('admin-delete-categories',$data[$i+1]->id)}}" onclick="return confirm('Are you sure?')" class="dropdown-item edit"> <i class="fa fa-gear"></i>Delete</a>
                        </div>
                      </div>
                    </div>
                    <div class="card-header d-flex align-items-center">
